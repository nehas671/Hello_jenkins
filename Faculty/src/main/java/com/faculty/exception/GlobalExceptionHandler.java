...
import com.faculty.exception.ErrorMessage;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ErrorMessage> handleFacultyNotFoundException(
			FacultyNotFoundException ex) {
		String error = "Faculty Does not exist !";
	...
	@ExceptionHandler(value = {FacultyPostNotFoundException.class})
	public ResponseEntity<ErrorMessage> handleFacultyPostNotFoundException(
			FacultyPostNotFoundException ex) {
		String error = "Faculty Email Does not exist !";
